					...
					<div class="container-fluid">
						<div class="navbar-header" style="display: flex">
							...
							<div style="position: absolute; top: 0px; right: 0px; float: right"  >
								...
								<div class="login_box" id="id" style="display: none;">빙빙 돌아가는 회전 목마 처럼</div>
			...
			<form action="/login.do" method="post" id="loginform">
				<div align="left" class="form_box">
					...
					<div class="form-group">
						<label for="InputMail">아이디</label> <input type="email"
							class="form-control" id="email" name="email" placeholder="vhdvhd0307@gmail.com">
					</div>
					<div class="form-group">
					...
					<input type="submit" value="Login" class="btn primary-btn" id="login">
				</div>
			</form>
		</section>
		<footer>
...
<script src="${pageContext.request.contextPath}/resources/js/ajaxTest.js"></script>
</body>
</html>