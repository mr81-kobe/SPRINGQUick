				...
				<hr>
					...
					<div align="left" class="form_box">
						...
						<div class="form-group">
							...
							<br>
							<textarea rows="14" cols="100" name="content" readonly="readonly">${board.content}</textarea>
						</div> 
						<div class="form-group">
						...
						<button id="updateButton" value="글 편집"></button>
						<button id="delbutton" value="글 삭제"></button>
